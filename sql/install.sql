...
CREATE TABLE IF NOT EXISTS `prefix_forum_post` (
	...
	`post_rating` float(9,3) NOT NULL DEFAULT '0.000',
	`post_count_vote` int(11) unsigned NOT NULL DEFAULT '0',
	`post_count_vote_up` int(11) NOT NULL DEFAULT '0',
	`post_count_vote_down` int(11) NOT NULL DEFAULT '0',
	`post_count_vote_abstain` int(11) NOT NULL DEFAULT '0',
