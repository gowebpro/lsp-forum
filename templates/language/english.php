...
return array(
	...
	'create_block_options' => 'General Settings',
	...
	'create_parent_error_descendants' => 'Sorry, that is not possible. You are attempting to move a parent forum or category into its own child structure. Please go back and try again, selecting a different parent forum.',
	'create_perms' => 'Copy permissions from',
	'create_perms_not' => 'Do not copy permissions',
	'create_perms_notice' => 'The newly created forum will be given the same access rights as the selected list. If nothing is selected, set up a forum will not be displayed on the forum to set access rights',
	'create_type' => 'State',
	'create_type_notice' => '',
	...
	'create_quick_reply' => 'Enable quick reply form',
	'create_quick_reply_notice' => 'Enables rapid response to this forum',
	'create_display_subforum_list' => 'Show the list of sub-forums',
	'create_display_subforum_list_notice' => 'Displays the sub-forums of the forum on the main page and the other as a link in the list, if these sub-forums enabled "Display the list of sub-forums Forum»',
	'create_display_on_index' => 'Display the list of sub-forums Forum',
	'create_display_on_index_notice' => 'Displays a link to the forum in the list of sub-forums parent forum, if one exists',
	'create_topics_per_page' => 'Topics per page',
	'create_topics_per_page_notice' => 'If non-zero, this value is replaced with the same amount to the default page (%%default%%)',
	'create_posts_per_page' => 'Messages on page topic',
	'create_posts_per_page_notice' => 'If non-zero, this value is replaced with the number of messages to the default page (%%default%%)',
	...
	'delete_move_items_error_descendants' => 'Sorry, that is not possible. You try to move threads and posts in one of the subforums delete forum.',
	...
	'attach_upload_title' => 'Upload attachments',
	'attach_upload_rules' => 'You can load files formats: %%FORMAT%%<br>The size of each file must not exceed %%SIZE%% Kб<br>Maximum number of uploaded files: %%COUNT%%',
	'attach_upload_file_choose' => 'Upload file',
	'attach_file_delete' => 'Delete',
	'attach_file_delete_confirm' => 'Delete file?',
	'attach_file_deleted' => 'File deleted',
	'attach_file_added' => 'Uploaded',
	'attach_file_hint' => '%%TEXT%%<br>File size: %%SIZE%%<br>Downloads: %%COUNT%%',
	'attach_error_too_much_files' => 'A message can contain a maximum of %%MAX%% files',
	'attach_error_bad_filesize' => 'The file size should be no more than %%MAX%% Kb',
	'attach_my_files' => 'My files',
	'attach_my_files_notice' => 'You can attach a file already loaded earlier',
	'attach_file_size' => 'File size',
	'attach_file_download' => 'Downloads',
	'attach_file_posts' => 'Attached to',
	'attach_this' => 'Attach this',
	...
	'acp_files' => 'Files',
	'acp_files_control' => 'Controls attachments',
	'acp_files_control_notice' => 'This section is under development.<br>Here are all of the downloaded files<br>In the future it will be possible to configure the component and manage file extensions',
	'acp_files_empty' => 'Attachment not found',
